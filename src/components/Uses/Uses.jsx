      ...
      <div className="container my-14">
        <div className="grid grid-cols-2 xl:grid-cols-4 gap-6">
          ...
          >
            ...
            Provides access to mental health resources and support services, which can be crucial during pandemic-related stress.
            </p>
            <p className="text-sm text-gray-400 mt-4">
            Can empower individuals to make informed decisions and stay safe.
